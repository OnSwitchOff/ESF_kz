...
{
	partial class panelESFpartHtab
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.l_PartH_ParticipantTin = new System.Windows.Forms.Label();
			this.l_PartH_ParticipantReorgTin = new System.Windows.Forms.Label();
			this.tbPartH_ParticipantReorgTin = new System.Windows.Forms.TextBox();
			...
			this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Percent, 50F));
			this.tableLayoutPanel1.Controls.Add(this.l_PartH_ParticipantTin, 0, 1);
			this.tableLayoutPanel1.Controls.Add(this.l_PartH_ParticipantReorgTin, 0, 2);
			this.tableLayoutPanel1.Controls.Add(this.tbPartH_ParticipantReorgTin, 1, 2);
    ...
    "лате косвенных налогов";
		...
		private System.Windows.Forms.Label l_PartH_ParticipantTin;
		private System.Windows.Forms.Label l_PartH_ParticipantReorgTin;
		private System.Windows.Forms.TextBox tbPartH_ParticipantReorgTin;
