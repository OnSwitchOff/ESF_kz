...
namespace ESF_kz.Forms
{
	partial class panelESFpartA
	{
		...
		private void InitializeComponent()
		{
			...
			this.tbPartA_Num = new System.Windows.Forms.TextBox();
			this.label3 = new System.Windows.Forms.Label();
			this.label4 = new System.Windows.Forms.Label();
			this.l_PaperESFDate = new System.Windows.Forms.Label();
			this.label6 = new System.Windows.Forms.Label();
			this.l_CorrectedESFDate = new System.Windows.Forms.Label();
			this.l_CorrectedESFAccSysNum = new System.Windows.Forms.Label();
			this.l_CorrectedESFNum = new System.Windows.Forms.Label();
			this.label10 = new System.Windows.Forms.Label();
			this.l_AddedESFDate = new System.Windows.Forms.Label();
			...
			((System.ComponentModel.ISupportInitialize)(this.epPartA_TurnoverDate)).BeginInit();
			this.SuspendLayout();
			// 
			// tableLayoutPanel1
			// 
			...
			this.tableLayoutPanel1.Controls.Add(this.l_PaperESFDate, 0, 6);
			this.tableLayoutPanel1.Controls.Add(this.label6, 0, 8);
			this.tableLayoutPanel1.Controls.Add(this.l_CorrectedESFDate, 0, 9);
			this.tableLayoutPanel1.Controls.Add(this.l_CorrectedESFAccSysNum, 0, 10);
			this.tableLayoutPanel1.Controls.Add(this.l_CorrectedESFNum, 0, 11);
			this.tableLayoutPanel1.Controls.Add(this.label10, 0, 12);
			this.tableLayoutPanel1.Controls.Add(this.l_AddedESFDate, 0, 13);
			...
			this.combxPartA_PaperESFReason.Enabled = false;
			this.combxPartA_PaperESFReason.FormattingEnabled = true;
			this.combxPartA_PaperESFReason.Items.AddRange(new object[] {
            "Простой системы",
			...
			this.combxPartA_PaperESFReason.SelectedIndexChanged += new System.EventHandler(this.combxPartA_PaperESFReason_SelectedIndexChanged);
			// 
			// chbxPartA_isPaperESF
			// 
			...
			this.epPartA_Date.ContainerControl = this;
			// 
			// epPartA_PaperESFDate
			// 
			this.epPartA_PaperESFDate.BlinkStyle = System.Windows.Forms.ErrorBlinkStyle.NeverBlink;
			this.epPartA_PaperESFDate.ContainerControl = this;
			// 
			// epPartA_PaperESFReason
			// 
			this.epPartA_PaperESFReason.BlinkStyle = System.Windows.Forms.ErrorBlinkStyle.NeverBlink;
			this.epPartA_PaperESFReason.ContainerControl = this;
			// 
			// epPartA_TurnoverDate
			// 
			...
			((System.ComponentModel.ISupportInitialize)(this.epPartA_TurnoverDate)).EndInit();
		...
		private System.Windows.Forms.TextBox tbPartA_Num;
		private System.Windows.Forms.Label label3;
		private System.Windows.Forms.Label label4;
		private System.Windows.Forms.Label l_PaperESFDate;
		private System.Windows.Forms.Label label6;
		private System.Windows.Forms.Label l_CorrectedESFDate;
		private System.Windows.Forms.Label l_CorrectedESFAccSysNum;
		private System.Windows.Forms.Label l_CorrectedESFNum;
		private System.Windows.Forms.Label label10;
		private System.Windows.Forms.Label l_AddedESFDate;
		...
		private System.Windows.Forms.ErrorProvider epPartA_Date;
		private System.Windows.Forms.Label l_PaperESFReason;
		private System.Windows.Forms.Label l_TurnoverDate;
		private System.Windows.Forms.ComboBox combxPartA_PaperESFReason;
		private System.Windows.Forms.CheckBox chbxPartA_isPaperESF;
